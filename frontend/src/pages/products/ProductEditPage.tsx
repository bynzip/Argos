...
// FIX: useCategories y useBrands son los nombres correctos (no useProductCategories/useProductBrands)
import {
  useProduct,
  useUpdateProduct,
  useCategories,
...
export default function ProductEditPage() {
  ...
  // FIX: Nombres correctos de los hooks
    ...
    <div className="p-8 max-w-[1000px] mx-auto">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
        <div className="form-card">
          <div className="flex items-center gap-2 pb-4 mb-6 border-b border-[var(--gray-200)] text-[14px] font-semibold text-[var(--gray-700)]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div className="sm:col-span-2 flex items-center gap-3 h-10">
              <input
                type="checkbox"
                id="activo"
                className="w-4 h-4 rounded border-[var(--gray-300)] text-[var(--color-brand-blue)]"
                {...register("activo")}
              />
              <label
                htmlFor="activo"
                className="text-sm font-medium text-[var(--gray-700)] cursor-pointer"
              >
          ...
          <div className="flex items-center gap-2 pb-4 mb-6 mt-10 border-b border-[var(--gray-200)] text-[14px] font-semibold text-[var(--gray-700)]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div className="space-y-1.5">
              ...
              />
              <p className="text-[11px] text-[var(--gray-400)] mt-1">
